...
download https://github.com/zhengshou/scnn/archive/$SCNN_VERSION.tar.gz scnn-$SCNN_VERSION.tar.gz
...
tar --totals -xf ../scnn-$SCNN_VERSION.tar.gz
...
cd scnn-$SCNN_VERSION/C3D_sample_rate
...
export LDFLAGS="-L../../lib -L$OPENCV_PATH/lib -ldl -lz"
make -j $MAKEJ BLAS=$BLAS OPENCV_VERSION=3 DISTRIBUTE_DIR=../.. VERBOSE=1
...
cp -a build/lib/libcaffe.so ../../lib/libcaffeC3DSampleRate.so
